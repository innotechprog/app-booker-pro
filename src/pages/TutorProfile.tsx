                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-blue-900">AI Assistant Available</h4>
                          <p className="text-sm text-blue-700">
                            Ask questions about this tutorial and get instant AI-powered answers. 
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="font-semibold text-gray-900 mb-3">Ask a Question</h4>
                        ...
                        <div key={discussion.id} className="border border-gray-200 rounded-lg p-4">
                          <div className="space-y-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-800">{discussion.question}</p>
                            </div>
                            ...
                            {discussion.answer ? (
                              <div className="bg-green-50 border-l-4 border-green-400 p-3 rounded-r-lg">
                                <div className="flex items-center space-x-2 mb-2">
                                  {discussion.answeredBy === "AI Assistant" ? (
                                    <Bot className="h-4 w-4 text-green-600" />
                                  ) : (
                                    <User className="h-4 w-4 text-green-600" />
                                  )}
                                  <span className="font-medium text-green-800">{discussion.answeredBy}</span>
                                </div>
                                <p className="text-green-700">{discussion.answer}</p>
                              </div>
                            ) : (
