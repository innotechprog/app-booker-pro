...
const WHATSAPP_NUMBER = "27684240852"; // South Africa, same as footer phone
  ...
  return (
    <footer className="bg-gray-900 text-white">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#20BD5A] text-white shadow-lg hover:shadow-xl z-50 transition-all duration-300 hover:scale-110 flex items-center justify-center"
