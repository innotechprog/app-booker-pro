-- Recruiter jobs and job applications (table_id only, no generic id)
-- Run after recruiter_tables.sql. Requires: recruiters, smart_apply_candidates
-- PKs: job_id CHAR(36), application_id CHAR(36) – generate in app with UUID()
